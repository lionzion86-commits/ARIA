...
export const SHIPPING_STATUS_ES = {
  purchased_usa:    { label: "Comprado en EE.UU.",  note: "Lo compramos en la tienda americana." },
  retailer_shipped: { label: "Tienda lo envió",     note: "La tienda lo envió a nuestro almacén en Miami." },
  miami_received:   { label: "Recibido en Miami",   note: "Llegó a nuestro almacén en Miami." },
  ...
  lince_available:  { label: "Disponible en Lince", note: "Listo para recoger en Av. José Leal 1436, Lince." },
...
export function canTransition(from, to) {
  ...
  if (from == null || from === "") return to === SHIPPING_FLOW[0];
